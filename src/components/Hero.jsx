      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16 relative z-10 flex flex-col-reverse lg:flex-row items-center gap-12 lg:gap-8">
        ...
        <div className="flex-1 text-center lg:text-left">
          ...
          <h2 className="text-xl md:text-2xl font-medium text-blue-200 mb-6">
            Automation & Integration Engineer | APIs, Workflows, Data
          </h2>

          <p className="text-blue-100/80 max-w-xl mx-auto lg:mx-0 text-lg mb-10 leading-relaxed font-light">
            I design and build automation workflows using APIs, data validation, and system integrations. I focus on creating efficient, scalable processes and am expanding into AI-driven automation and workflow orchestration.</p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 mb-10">
            ...
            <a
              href="/Albion_Burrniku_Resume.pdf"
              target="_blank"
          ...
          <div className="flex flex-wrap justify-center lg:justify-start gap-3 text-sm font-medium text-blue-200">
            ...
            <span className="flex items-center gap-1.5"><div className="w-1.5 h-1.5 rounded-full bg-blue-400"></div> Automation & Integration</span>
            <span className="flex items-center gap-1.5"><div className="w-1.5 h-1.5 rounded-full bg-blue-400"></div> API, Data Validation & Workflows</span>
          </div>
        </div>
        ...
        <div className="flex-1 flex justify-center lg:justify-end">
          <div className="relative w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96">
            ...
            <div className="absolute -top-6 -right-6 w-12 h-12 bg-white rounded-xl shadow-xl flex items-center justify-center rotate-12">
              <div className="w-6 h-6 bg-blue-600 rounded-full text-white flex items-center justify-center font-bold text-xs shadow-inner">AB</div>
            </div>
          </div>
        </div>
      </div>
